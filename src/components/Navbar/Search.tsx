    ...
    <div className="relative w-full max-w-md">
      <div className="relative">
        ...
        <Input
          ...
          className="pl-10 pr-4 py-2 border border-gray-300 bg-amber-50 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
        />
        {isLoading && (
